...
{
    public class CanViewVTScansReqHandler : AuthorizationHandler<CanViewVTScansRequirement>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, CanViewVTScansRequirement requirement)
        {
            if (context.User.IsInRole(DefaultRoles.Admin.ToString()) || 
                ...
                context.User.IsInRole(DefaultRoles.Scanner.ToString()) ||
